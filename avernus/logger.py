...
Any modules and plugins that wish to use logging should import the Log object:
...
class Debug(object):
    """Singleton class that acts as interface for avernus's logger"""

    def __init__ (self):
        """ Configure the avernus logger """
    ...
    def __init_logger(self):
        Debug.__logger = logging.getLogger('avernus')
